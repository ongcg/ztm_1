  ...
  <div>
    <div id="header" class="bg-[url('/hero-bg.jpg')] px-20">
      ...
      <div class="grid grid-cols-2 pb-20 pt-10">
        ...
        <div>
          <h1
            class="text-8xl text-white text-center font-lilita uppercase mt-5"
          >
            Classic Burger
          </h1>
          <h2
            class="text-6xl text-white text-center font-lilita uppercase my-5"
          >
            With Onion
          </h2>
          <p class="text-white text-center font-roboto font-light px-20">
            Our signature burger now comes with onion and cheese. You can
            customize it to your likings. Freshly made to order, all in a
            Brioche style bun
          </p>
        </div>
      </div>
    ...
    >
      ...
      <p
        ...
        "
      >
        Spend quality time with your family and eat an affordable, nutrition and
        delicious meal. Not all burgers are fast food.All our burgers are
        handmade to order for you and your family to enjoy
      </p>
      <button class="font-oswald uppercase bg-red-500 text-white py-3 px=6">
        Explore Full Menu
      </button>
    </div>

    <div id="section 2" class="grid grid-cols-3 text-center px-20 py-10 bg-yellow-500 gap-5">
        <div>
          <svg
          ...
          <p class="font-light">
            We use our own recipes and only the best ingredients to make our
        ...
        <div>
          ...
          <p class="font-light">
            We purchase our ingredients from the best suppliers daily, to ensure
            the freshest quality of our burgers
          </p>
        </div>
        <div>
          <svg
    ...
    <div id="section-3" class="text-center">
      <h2 class="text-6xl font-oswald text-red-500 uppercase font-medium pt-10">
        Our Crazy Burgers
      </h2>
      <p class="text-gray-500 font-light text-xl my-10 px-60">
        Whether you are looking for the classics, our specialties, or just
        wraps, salads, and fries. We have it all. We always have something that
        rewards your tastebud
      </p>
      ...
      >
        <div
          class="
            col-span-5
            bg-cover bg-center bg-[url('/fries-bg-1.jpg')]
            pl-20
            pb-10
            pt-10
          "
        >
          ...
          <h4>Cheese Fries</h4>
          <button
            class="uppercase bg-red-500 text-white text-lg py-3 px-8 mt-5"
          >
            Claim now
          </button>
        </div>
        ...
        <div
          class="
            col-span-7
            bg-cover bg-center bg-[url('/burger-bg-1.jpg')]
            text-right
            px-10
            pt-10
          "
    ...
    <div id="section 4" class="px-10 bg-gray-100 py-20">
      <div class="grid grid-cols-2">
        <img src="about.png" alt="" class="pl-20" />
        <h3 class="font-oswald text-5xl uppercase pl-10 pr-4 pt-10 leading-snug">Nothing Brings People Together likes a good burger</h3>
      </div>
    ...
    <div id="section 5" class="grid grid-cols-5 bg-yellow-500 text-amber-900">
      <div class="col-span-3 pl-20 pt-16 pb-16">
        ...
        <p class="text-lg my-7">Bye bye long queues. Order before and your food will be ready in a flash. Enjoy the convernience of ordering food online at anytime and from any location</p>
        <button>
          <img src="/appstore.png" class="h-[50px]" alt="" />
        </button>
        <button>
          <img src="/googleplay.png" class="h-[50px]" alt="" />
        </button>
      </div>
